...
def login():
    if request.method == 'POST':
        ...
        # The input is directly concatenated into the SQL command.
        # FIX: Use parameterized queries: "SELECT * FROM users WHERE username=? AND password=?"
...
def search():
    ...
    # The user input 'q' is reflected back to the page without sanitization.
    # FIX: Use templates that auto-escape (like standard Flask/Jinja2 templates) 
    # or explicitly escape input using html.escape().
    template = f'''
